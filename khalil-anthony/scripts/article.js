...
Article.prototype.toHtml = function() {
  ...
  let articleTemplateToRender = Handlebars.compile(articleTemplate);
  ...
  return articleTemplateToRender(this);
};

// COMMENT: Why are there parentheses around "(a,b)" in the .sort() method, but not around the "articleObject" or "article" arguments in the .forEach() methods?
// (a,b) are arguments for the sort() method. While articleObject and article are functions. We are able to tell because of the open parenthesis after ".sort".
rawData.sort((a,b) => {
